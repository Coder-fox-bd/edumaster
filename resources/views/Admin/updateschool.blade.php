      ...
      <div class="panel-body">
        <form action="" method="post" enctype="multipart/form-data" id="form-user" class="form-horizontal">
          ...
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="school_code" placeholder="school code" id="input-username" class="form-control" value="{{$school->school_code}}">
          ...
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="school_name" placeholder="school name" id="input-username" class="form-control" value="{{$school->school_name}}">
            	<div class="text-danger"></div>
          	</div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="location" placeholder="location" id="input-username" class="form-control" value="{{$school->location}}">
            	<div class="text-danger"></div>
          	</div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="total_student" placeholder="total student" id="input-username" class="form-control" value="{{$school->total_student}}">
                <div class="text-danger"></div>
          	</div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="school_account" placeholder="school account" id="input-username" class="form-control" value="{{$school->school_account}}">
            	<div class="text-danger"></div>
          	</div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="school_account_type" placeholder="school account type" id="input-username" class="form-control" value="{{$school->school_account_type}}">
            	<div class="text-danger"></div>
          	</div>
          </div>
          <div class="form-group required has-error">
            ...
            <div class="col-sm-10">
              <input type="text" name="academic_session" placeholder="accademic session" id="input-username" class="form-control" value="{{$school->academic_session}}">
            	<div class="text-danger"></div>
          	</div>
          </div>
          @endforeach
